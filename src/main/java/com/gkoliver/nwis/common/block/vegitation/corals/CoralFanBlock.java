...
public class CoralFanBlock extends Block implements IWaterLoggable {
	...
	public CoralFanBlock(Properties properties, ECoralType type, CoralWallFanBlock wallFan) {
		super(properties);
		this.type = type;
