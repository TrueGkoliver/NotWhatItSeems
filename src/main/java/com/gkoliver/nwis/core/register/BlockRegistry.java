...
import com.gkoliver.nwis.common.block.other.CoralWallFanBlock;
...
public class BlockRegistry {
	...
	public static ArrayList<RegistryObject<Block>> genCoral(String name) {
		...
		NWISBlock alive = new NWISBlock(PROP_CORAL);
		NWISBlock dead = new NWISBlock(PROP_CORAL);
		NWISBlock alive_fan = new NWISBlock(PROP_CORAL);
		NWISBlock dead_fan = new NWISBlock(PROP_CORAL);
		CoralWallFanBlock alive_wall_fan = new CoralWallFanBlock(PROP_CORAL);
		CoralWallFanBlock dead_wall_fan = new CoralWallFanBlock(PROP_CORAL);
	...
	public static final RegistryObject<Block> STATIC_POSIMOSS_EUMUS = genBlock("fake_posimoss_eumus", new NWISBlock(PROP_SOIL));
	
	
	//Quark: Glowing Caves
	public static final RegistryObject<Block> FAKE_GLOWCELIUM = genBlock("fake_glowcelium", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> FAKE_GLOWCELIUM_A = genBlock("fake_glowceilium_a", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> FAKE_BIG_GLOWSHROOM = genBlock("fake_big_glowshroom", new NWISNorthableBlock(PROP_MUSH));
	public static final RegistryObject<Block> FAKE_GLOWSHROOM = genBlock2("fake_glowshroom", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> FAKE_CAVE_ROOTS = genBlock("fake_cave_roots", new NWISBlock(PROP_MUSH));
	//Sapling
	public static final RegistryObject<Block> FROSTY_SAPLING = genBlock2("fake_qsap_frosty", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> SERENE_SAPLING = genBlock2("fake_qsap_serene", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> WARM_SAPLING = genBlock2("fake_qsap_warm", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> SUNNY_SAPLING = genBlock2("fake_qsap_sunny", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> SWEET_SAPLING = genBlock2("fake_qsap_sweet", new NWISBlock(PROP_MUSH));
	//Autuminity
	public static final RegistryObject<Block> MAPLE_SAPLING = genBlock2("fake_maple_sapling", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> MAPLE_SAPLING_RED = genBlock2("fake_maple_sapling_red", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> MAPLE_SAPLING_YELLOW = genBlock2("fake_maple_sapling_yellow", new NWISBlock(PROP_MUSH));
	public static final RegistryObject<Block> MAPLE_SAPLING_ORANGE = genBlock2("fake_maple_sapling_blue", new NWISBlock(PROP_MUSH));
	//Atmospheric
