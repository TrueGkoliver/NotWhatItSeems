...
public class ClientEvents {
	...
	public static void onColorBlockRegister(ColorHandlerEvent.Block event) {
	    ...
	    }, BlockRegistry.STATIC_GRASS.get(), BlockRegistry.STATIC_GRASS_A.get(), BlockRegistry.FAKE_TALL_GRASS.get(), BlockRegistry.FAKE_GRASS.get(), BlockRegistry.FAKE_TALL_FERN.get());
	}
